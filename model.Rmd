...
avoid a downward bias on the dispersion. This bias adjustment is 
similar conceptually to the the use of $\frac{1}{n-1}$ in estimating
the sample variance.
...
so that the library size differences across samples are minimized.
