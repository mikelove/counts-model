...
the estimates over the mean of normalized counts for each gene.  There
are two per-gene estimates, an initial estimate which looks only at
the data for a single gene (`gene-est`, black points), and a final
